...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'JNixonHelloContigsFilter'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from JNixonHelloContigsFilter.JNixonHelloContigsFilterImpl import JNixonHelloContigsFilter  # noqa @IgnorePep8
impl_JNixonHelloContigsFilter = JNixonHelloContigsFilter(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'JNixonHelloContigsFilter'
