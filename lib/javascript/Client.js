...
function JNixonHelloContigsFilter(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.filter_contigs = function (workspace_name, contigset, minimum, _callback, _errorCallback) {
        if (typeof workspace_name === 'function')
            throw 'Argument workspace_name can not be a function';
        if (typeof contigset === 'function')
            throw 'Argument contigset can not be a function';
        if (typeof minimum === 'function')
            throw 'Argument minimum can not be a function';
        ...
        return json_call_ajax(_url, "JNixonHelloContigsFilter.filter_contigs",
            [workspace_name, contigset, minimum], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "JNixonHelloContigsFilter.status",
